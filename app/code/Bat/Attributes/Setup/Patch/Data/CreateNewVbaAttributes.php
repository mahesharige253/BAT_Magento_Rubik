 ...
 */
class CreateNewVbaAttributes implements DataPatchInterface, PatchRevertableInterface
{
    private const VIRTUAL_BANK_ACCOUNT = 'virtual_account_new';
    private const VIRTUAL_BANK_NAME = 'virtual_bank_new';
