...
class RegistrationConsentFormOptions extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
    /**
    ...
    public function getAllOptions()
    {
        ...
        $data = $this->consentformFactory->create()->getCollection()
            ->addFieldToFilter('consent_type', ['in' => array('Registration','Registration,Account')]);
