...
use Magento\RequisitionListGraphQl\Model\Resolver\RequisitionList\Items as ResolverItems;

class Items extends ResolverItems
{
    /**
    ...
    public function __construct(
        ...
        parent::__construct($itemRepository, $productRepository, $searchCriteriaBuilder, $idEncoder);
